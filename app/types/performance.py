...
class Performance:
    ...
    def table_cols() -> list[dict]:
        return [
            {"name": "year", "label": "Year", "field": "year", "sortable": True, "align": "center"},
            ...
            {"name": "overs_bowled", "label": "Overs", "field": "overs_bowled", "sortable": True},
            ...
            {"name": "fivewktinn", "label": "5+", "field": "fivewktinn", "sortable": True},
            {"name": "best", "label": "Best", "field": "best_bowling", "sortable": False, "align": "center"},
            {"name": "caught", "label": "Ct", "field": "caught", "sortable": True},
            {"name": "stumped", "label": "St", "field": "stumped", "sortable": True},
            {"name": "fifties", "label": "50", "field": "fifties", "sortable": True},
            {"name": "hundreds", "label": "100", "field": "hundreds", "sortable": True},
            {"name": "caughtwkt", "label": "Ct wkt", "field": "caughtwkt", "sortable": True},
            {"name": "captain", "label": "Captain", "field": "captain", "sortable": True},
            {"name": "keptwicket", "label": "Keeper", "field": "keptwicket", "sortable": True},
        ]
