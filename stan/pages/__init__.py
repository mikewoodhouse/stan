# Could we scan the modules in this directory and auto-generate this?
# i.e identify all the `show_*` functions and import them? (assuming `show_*` defines a page)
# Or use some decorator to mark them as pages, perhaps?
