...
from stan.types import BattingAverage, BowlingAverage, Partnership, Season, SeasonRecord
from stan.utils import add_slot_to_table, coldef, page_header, sortable
